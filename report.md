...
| 指標 | 基線 | v1 | v5 | v9 | v10 | **v11** | 總增幅 |
|---|---|---|---|---|---|---|---|
| F1@0.5 | 0.22 | 0.36 | 0.566 | 0.668 | 0.687 | **0.727** | **+230%** |
| F1@0.3 | 0.26 | 0.44 | 0.683 | 0.735 | 0.754 | **0.794** | **+205%** |
| meanIoU | 0.54 | - | 0.607 | 0.657 | 0.650 | **0.689** | +28% |
| Frame F1 | 0.37 | 0.42 | 0.612 | 0.692 | 0.729 | **0.738** | +99% |
| Frame IoU | 0.26 | - | 0.481 | 0.553 | 0.587 | **0.603** | +132% |

分影片 F1@0.5：
| 影片 | 基線 | v9 | v10 | **v11** |
|---|---|---|---|---|
| test_001 | 0.29 | 0.800 | 0.800 | **1.000** |
| test_002 | 0.46 | 0.857 | 0.857 | **0.857** |
| test_003 | 0.00 | 0.444 | 0.444 | **0.444** |
| test_004 | 0.31 | 0.667 | 0.667 | **0.667** |
| test_005 | 0.04 | 0.571 | 0.667 | **0.667** |
